...
export default function OfficeComplexProjectPage() {
  ...
  const t = useTranslations('work.commercial_complex')
  ...
  const baseProject = getProjectById('commercial-office')
  
  const project = {
    ...baseProject,
    title: t('title'),
    subtitle: t('subtitle'),
    category: locale === 'el' ? tCommon('category_residential') : 'Residential',
    heroVideo: '/Our-Work-Content/Resitental-metal-const-Hero.mp4',
    heroImage: baseProject?.image || '/DJI_20251002103154_0038_D.JPG',
    gallery: [
      '/Our-Work-Content/Resitental-metal-const-img1.png',
      '/Our-Work-Content/Resitental-metal-const-img2.png',
      '/Our-Work-Content/Resitental-metal-const-img3.png'
    ],
    specifications: {
    ...
    location: t('location'),
    challenges: tCommon.raw('commercial_complex_challenges') as string[],
    solutions: tCommon.raw('commercial_complex_solutions') as string[],
    testimonial: {
      text: tCommon('testimonial_commercial_complex'),
      author: tCommon('property_owners'),
          ...
          >
            ...
            <div className="flex items-center justify-center gap-6 pt-4">
              <div className="text-center">
                ...
                <div className={`text-white text-lg font-semibold ${locale === 'el' ? 'greek-text' : ''}`}>{t('type')}</div>
              </div>
