...
export default function ApartmentComplexExpansionPage() {
  ...
  const project = {
    ...
    specifications: {
      area: tCommon('apartment_complex.specifications.area'),
      duration: tCommon('apartment_complex.specifications.duration'),
      budget: tCommon('apartment_complex.specifications.budget'),
      architect: tCommon('apartment_complex.specifications.architect')
    },
    features: [
