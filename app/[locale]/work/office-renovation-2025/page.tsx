...
export default function OfficeRenovationProjectPage() {
  const ref = useRef(null)
  const isInView = useInView(ref, { once: true, margin: "-100px" })
  const t = useTranslations('work.office_renovation_2025')
  ...
  const baseProject = getProjectById('office-renovation-2025')
  ...
  const project = {
    ...
    title: t('title'),
    subtitle: t('subtitle'),
    category: tCommon('category_commercial'),
    heroVideo: '/project3/1123.mp4',
    heroImage: baseProject?.image || '/project3/images/IMG_1415.png',
    beforeImages: [
      '/project3/before/WhatsApp Image 2025-11-05 at 20.18.45.jpeg',
      '/project3/before/WhatsApp Image 2025-11-05 at 20.18.46.jpeg',
      '/project3/before/hgghgh.jpeg'
    ],
    afterImages: [
      '/project3/images/IMG_1415.png',
      '/project3/images/IMG_1380.png',
      '/project3/images/IMG_1374.png',
      '/project3/images/IMG_1366.png',
      '/project3/images/IMG_1349.png',
      '/project3/images/IMG_1362.png'
    ],
    specifications: {
    ...
    location: t('location'),
    challenges: tCommon.raw('office_renovation_challenges') as string[],
    solutions: tCommon.raw('office_renovation_solutions') as string[],
    testimonial: {
      text: tCommon('testimonial_office_renovation'),
      ...
      <section ref={ref} className="py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div 
            ...
            animate={isInView ? "visible" : "hidden"}
          >
            <p className={`text-lg md:text-xl text-gray-700 leading-relaxed text-center ${locale === 'el' ? 'greek-text' : ''}`}>
              {project.description}
            </p>
          </motion.div>
            ...
            {project.beforeImages.map((image, index) => (
              ...
              >
                <div className="relative h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500">
                  <Image
                    src={image}
                    alt={`${project.title} - Before Image ${index + 1}`}
                    fill
