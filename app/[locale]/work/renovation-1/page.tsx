...
export default function RenovationProjectPage() {
  ...
  const project = {
    ...
    heroImage: '/zio_dudee_Dramatic_beforeafter_renovation_transformation_show_b8da3948-e3b2-44e8-9a9a-becce35a9d68_0.png',
    gallery: [
    ...
    specifications: {
      area: tCommon('renovation_1.specifications.area'),
      duration: tCommon('renovation_1.specifications.duration'),
      budget: tCommon('renovation_1.specifications.budget'),
      architect: tCommon('renovation_1.specifications.architect')
    },
    features: [
      'Complete structural reinforcement and modernization',
      'Open-plan living space with seamless indoor-outdoor flow',
      'Premium kitchen with custom cabinetry and Italian appliances',
      'Master suite with walk-in closet and luxury bathroom',
      'Energy-efficient windows and insulation upgrade',
      'Modern lighting system with smart controls',
      'Hardwood flooring throughout main living areas',
      'Landscaped garden with outdoor entertainment area'
    ],
    challenges: [
      'Outdated electrical and plumbing systems',
      'Structural issues requiring foundation work',
      'Preserving original architectural character',
      'Working around existing family occupancy'
    ],
    solutions: [
      'Complete rewiring and replumbing with modern systems',
      'Careful structural analysis and reinforcement',
      'Blending modern amenities with original features',
      'Phased construction to minimize disruption'
    ],
    testimonial: {
      text: 'The transformation is incredible. They managed to preserve the character of our family home while making it completely modern and functional. We love our new space!',
      author: 'Elena & Dimitris Papadopoulos',
      role: 'Homeowners'
    }
  }
