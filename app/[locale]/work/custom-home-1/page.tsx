...
export default function CustomHomeProjectPage() {
  ...
  const project = {
    ...
    heroImage: '/zio_dudee_Distinctive_ultra-modern_custom_home_at_dusk_featur_b3f74bd8-d1e1-417d-b64d-d29e71eed53b_2.png',
    gallery: [
      ...
      '/zio_dudee_Ultra-modern_sleek_office_building_at_dusk_with_exp_33e79970-4bc7-4b97-970f-2229ec32ea35_3.png'
    ],
    specifications: {
      area: tCommon('custom_home_1.specifications.area'),
      duration: tCommon('custom_home_1.specifications.duration'),
      budget: tCommon('custom_home_1.specifications.budget'),
      architect: tCommon('custom_home_1.specifications.architect')
    },
    features: [
      'Custom architectural design tailored to client preferences',
      'Seamless indoor-outdoor living with retractable glass walls',
      'Premium natural stone and wood finishes throughout',
      'Custom-built kitchen with integrated appliances',
      'Master suite with private balcony and spa-like bathroom',
      'Home office with panoramic mountain views',
      'Solar panel system for energy efficiency',
      'Landscaped garden with native Mediterranean plants'
    ],
    challenges: [
      'Complex site topography requiring custom foundation design',
      'Client requested multiple design revisions',
      'Sourcing rare materials from international suppliers',
      'Coordinating custom millwork and finishes'
    ],
    solutions: [
      'Advanced 3D modeling for precise foundation planning',
      'Flexible design process with regular client consultations',
      'Established relationships with premium material suppliers',
      'Skilled craftsmen for custom fabrication work'
    ],
    testimonial: {
      text: 'Working with Nicolas and his team was an incredible experience. They brought our vision to life and exceeded our expectations. The attention to detail and quality is remarkable.',
      author: 'Sophia & George Petrou',
      role: 'Homeowners'
    }
  }
