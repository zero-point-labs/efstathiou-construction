...
export default function OfficeComplexProjectPage() {
  ...
  const project = {
    ...
    heroImage: '/zio_dudee_Ultra-modern_sleek_office_building_at_dusk_with_exp_33e79970-4bc7-4b97-970f-2229ec32ea35_3.png',
    gallery: [
    ...
    features: [
      'Modern glass facade with energy-efficient glazing',
      'Flexible office layouts adaptable to various business needs',
      'Advanced HVAC system with individual climate control',
      'High-speed fiber optic infrastructure throughout',
      'Underground parking for 80 vehicles',
      'Rooftop terrace with panoramic city views',
      'Premium elevator system with smart access control',
      'Sustainable design with LEED certification potential'
    ],
    challenges: [
      'Complex zoning requirements in city center',
      'Coordination with multiple utility providers',
      'Minimizing disruption to surrounding businesses',
      'Meeting strict energy efficiency standards'
    ],
    solutions: [
      'Early engagement with city planning department',
      'Comprehensive utility mapping and coordination',
      'Phased construction with careful scheduling',
      'Advanced building systems and materials selection'
    ],
    testimonial: {
      text: 'The office complex has transformed our business operations. The modern facilities and efficient design have significantly improved our team productivity and client experience.',
      author: 'Michael Constantinou',
      role: 'CEO, Tech Solutions Cyprus'
    }
  }
