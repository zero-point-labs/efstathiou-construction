...
export default function LuxuryVillaProjectPage() {
  ...
  const project = {
    ...
    heroImage: '/zio_dudee_Ultra-modern_luxury_house_at_dusk_with_selective_fl_d183ddd8-f296-430b-9dee-55fdd86d23e8_1.png',
    gallery: [
    ...
    features: [
      'Floor-to-ceiling glass windows for panoramic views',
      'Premium marble and hardwood finishes throughout',
      'Smart home automation system',
      'Infinity pool with integrated lighting',
    ...
    challenges: [
      'Complex foundation work due to rocky terrain',
      'Coordination of multiple luxury material suppliers',
      'Strict building regulations compliance',
      'Weather delays during winter months'
    ],
    solutions: [
      'Specialized drilling equipment for foundation',
      'Established direct relationships with suppliers',
      'Early engagement with local authorities',
      'Flexible scheduling with weather contingencies'
    ],
    testimonial: {
      text: 'The team exceeded our expectations in every way. The attention to detail and quality of workmanship is outstanding. We could not be happier with our new home.',
